!(function () {
  ...
  function A(e, t) {
    ...
    if (!(e instanceof Array)) return A([e], t)
    if (!(t instanceof Array)) return A(e, [t])
  ...
  var n,
    ...
    u =
      ...
      (c.getHighestAccessibleUrl = function (e) {
        var t,
          o = c.getHighestAccessibleWindow(e),
          i = o.topFrame
        if (o.err)
          try {
            try {
  ...
  function D(e, t) {
    for (var o = 0, i = e; o < i.length; o++) {
      var n = i[o]
      if (n.event === t.event && A(t.account, n.account)) {
  ...
  ;((t = n = n || {})[(t.None = 0)] = 'None'),
    (t[(t.Cookie = 1)] = 'Cookie'),
    (t[(t.LocalStorage = 2)] = 'LocalStorage')
  var l =
    ((o.prototype.checkLocalStorage = function () {
      try {
    ...
    (o.prototype.setOnMainDomainWithExpiration = function (e, t) {
      ...
      for (
        ...
        var s =
            'domain=.' + (a = n.slice(n.length - r - 1, n.length).join('.')),
  ...
  function o(e, t) {
    ;(this.cookieValue = null),
      ...
      (this.cookieOrigin = n.None),
      (this.useLocalStorage = this.checkLocalStorage())
  }
  var h =
    ((p.prototype.fillQueryStringParams = function (e) {
      this.gaid && e.push('ai=' + this.gaid),
        ...
        void 0 !==
          new l('cto_clc', this.readonlyCookieRetentionTime).getValue() &&
          e.push('clc=1')
    }),
      ...
      if ((e.idfsRead && this.idfsCookie.setCookieRead(), e.callbacks))
        for (
          ...
          a.parentNode.insertBefore(n, a),
            u.removeLater(this.exceptionHandler, n)
        }
      else
        e.optout
    ...
    (p.prototype.setCanWriteCookie = function () {
      if (
        ...
        e.setValueWithNoDomain('ChUIBBINbXlHb29nbGVSdGJJZBgBIAE'),
          (this.canWriteCookie = void 0 !== e.cookieValue),
          e.removeWithNoDomain()
  ...
  function p(e, t, o) {
    ;(this.readonlyCookieRetentionTime = 0),
      ...
      (this.acidCookie = new l(
        'criteo_acid',
        this.readonlyCookieRetentionTime,
      )),
      (this.axidCookie = new l('cto_axid', this.readonlyCookieRetentionTime)),
      (this.ccpCookie = new l(
        'criteo_cookie_perm',
        this.readonlyCookieRetentionTime,
      )),
      (this.guidCookie = new l(
        'cto_idcpy',
        this.identificationCookieRetentionTime,
      )),
      (this.idfsCookie = new l(
        'cto_idfs',
        this.identificationCookieRetentionTime,
      )),
      (this.lwidCookie = new l(
        'cto_lwid',
        this.identificationCookieRetentionTime,
      )),
      (this.optoutCookie = new l('cto_optout', this.optoutCookieRetentionTime)),
      (this.pxsigCookie = new l('cto_pxsig', this.readonlyCookieRetentionTime)),
      (this.secureIdCookie = new l(
        'cto_sid',
        this.identificationCookieRetentionTime,
      )),
      (this.bundleCookie = new l(
        'cto_bundle',
        this.identificationCookieRetentionTime,
      )),
  ...
  var f =
    ((m.prototype.createIframe = function (e, t, o) {
      var i = document.createElement('iframe'),
        n = encodeURIComponent || escape,
        a = u.getHighestAccessibleUrl(window),
        r = n(u.extractHostname(a)),
        s = {
      ...
      return (
        ...
        (i.height = '0'),
        (i.frameBorder = '0'),
        i.setAttribute('style', 'border-width:0px; margin:0px; display:none'),
  ...
  var _ = new RegExp(
    ...
    F =
      ((g.prototype.canRetrieveMetrics = function () {
  ...
  var I =
    ((v.prototype.trySetPageId = function (e, t) {
      this.isCbsEnabled &&
    ...
    (v.prototype.tryRunActionAfterAdBlockDetectionOrImmediate = function (
      t,
      e,
    ) {
      var o = this,
  ...
  function T(e, t, o, i, n) {
    if (
      ((function () {
        ...
        var t = 'enable' === e[1],
          o = Number(e[3])
        new l('criteoTagDebugMode', t ? 864e5 : 0).setValueWithNoDomain(
      ...
      return (
        (window.onerror = (function (a) {
          return function (e, t, o, i) {
            ...
            return (
              r.pushError(n),
              !(!a || 'function' != typeof a) && a.apply(window, [e, t, o, i])
            )
          }
        })(window.onerror)),
        r
  ...
  if (!window.criteo_q || window.criteo_q instanceof Array) {
    ...
    ;(window.criteo_q = (function () {
            ...
            (w.addProtectedEventListener(
              ...
              function (e) {
                !(function (e, t, o, i, n, a, r, s, c) {
                  ...
                  c.stopPropagation(),
                    (e.isSyncframeLoading = !1),
                    i.checkCookies(u),
                    e.waitingForSyncframe && l(e, t, o, i, n, a, r, s)
                })(t, o, i, n, a, r, s, c, e)
              },
              !0,
            ),
            o.queue.push({ event: 'appendtag', element: e }))
        }
      }
      function a(e, t) {
        !(function (e) {
      ...
      function C(e, t, o, i) {
        if (
          (!e.bodyReady ||
            ...
            (t.container = u.appendCriteoContainer(document.body)),
          i.url)
        ) {
          var n = void 0
          i.isImgUrl
      ...
      function S(e, t) {
        return !e.domReady && t.requiresDOM && 'no' !== t.requiresDOM
          ...
          : (delete t.requiresDOM,
            t.event
              ? (t.account && s(t.account, e.accounts),
      ...
      function p(e, t, o, i, n, a, r, s, c, u, l) {
        ...
        switch (s.event) {
          ...
          case 'setgoogleadvertisingid':
            return (
              (o.gaid = s.gaid),
              R(n.extraData, e.actions, { event: 'setdata', site_type: 'aa' })
            )
          case 'setappleadvertisingid':
            return (
              (o.idfa = s.idfa),
              R(n.extraData, e.actions, { event: 'setdata', site_type: 'aios' })
            )
          case 'setemail':
          case 'sethashedemail':
          case 'ceh':
          ...
          case 'flushevents':
            return (
              x(e, t, o, i, n, a, r, c !== u.length - 1 || 0 !== l.length), 1
            )
          case 'setaccount':
        ...
        if (
          ...
          if (!r.manualDising && (!s || r.partialDis)) {
            for (var f = [], m = 0, g = o.accounts; m < g.length; m++) {
              var v = g[m]
              P(o.disingScheduled, v) || f.push(v)
            }
            0 < f.length &&
              (function (e, t, o) {
                var i = S(t, o)
                null !== i || (b(e, t, o), t.actions.push(V(o)))
          ...
          o.actions = []
          i.tryRunActionAfterAdBlockDetectionOrImmediate(
            function () {
              if (!y) {
                ...
                'beacon' === n.requestType && navigator.sendBeacon
      ...
      return w.catchAndStoreException(function () {
        return (
          y.checkAcid(),
          y.checkClientSideIdentityStatus(),
          y.setCop(window),
          (function (e, t, o, i, n, a, r, s) {
            e.setWaitingFlag(i),
              e.waitingForSyncframe &&
                w.setProtectedTimeout(function () {
                  l(e, t, o, i, n, a, r, s)
                }, 1e4)
          })(
            k,
          ...
          (function (e, t) {
            var o,
              i,
              n =
                null === (o = window.Criteo) || void 0 === o
                  ? void 0
                  : o.oneTagConfig
            return null !== (i = n && n[e]) && void 0 !== i ? i : t
          })('visitEventEnabled', !1) &&
            (function (e, t) {
              window.addEventListener &&
      ...
      k.adBlockDetector,
      (window.criteo_q.adBlockDetector = k.adBlockDetector),
      window.criteo_q.push.apply(window.criteo_q, k)
  }
})()
